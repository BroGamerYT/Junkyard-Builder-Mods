...
Write-Host "     JUNKYARD WEIGHT MOD BUILDER          " -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Green
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "Pfad: E:\Games\Steam\steamapps\common\Junkyard Builder\Mods\JunkyardWeightMod.dll" -ForegroundColor Gray
